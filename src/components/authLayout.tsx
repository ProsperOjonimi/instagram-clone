...
function AuthLayout() {
  ...
  const footerText = languageTextFooter.filter(
  ...
  const footerData = [
    ...
    {
      linkName: footerText.text1,
      path: "https://about.instagram.com/",
    },
    {
      linkName: "Blog",
      path: "https://about.instagram.com/blog/",
    },
    {
      linkName: footerText.text2,
      path: "https://about.instagram.com/about-us/careers",
    },
    {
      linkName: footerText.text3,
      path: "https://help.instagram.com/",
    },
    {
      linkName: "API",
      path: "https://developers.facebook.com/docs/instagram",
    },
    {
      linkName: footerText.text4,
      path: "https://www.instagram.com/legal/privacy/",
    },
    {
      linkName: footerText.text5,
      path: "https://www.instagram.com/legal/terms/",
    },
    {
      linkName: footerText.text6,
      path: "https://www.instagram.com/explore/locations/",
    },
    {
      linkName: "Instagram Lite",
      path: "https://www.instagram.com/web/lite/",
    },
    {
      linkName: "Meta AI",
      path: "https://www.meta.ai/?utm_source=foa_web_footer",
    },
    {
      linkName: "Threads",
      path: "https://www.threads.com/",
    },
    {
      linkName: footerText.text7,
      path: "https://www.facebook.com/help/instagram/261704639352628",
    },
    {
      linkName: "Meta Verified",
      path: "https://www.instagram.com/accounts/meta_verified/?entrypoint=web_footer",
    },
  ];
          ...
          <div className="flex w-[975px] px-[20px]">
            ...
            <div className="w-full flex justify-end ">
              <div className="flex gap-5 items-center">
                <Link
                  to="/accounts/login"
                  className="bg-[#4A5DF9] text-[white] px-[16px] h-[32px] text-[14px] font-semibold rounded-lg flex items-center "
                >
                  {LoginText.text3}
                </Link>
                <Link
                  to="/accounts/login"
                  className="text-[#708DF0] font-semibold text-[14px] hover:text-[#A3BCFF] hover:underline"
                >
                  {LoginText.text7}
                </Link>
              </div>
      ...
      <div className="bg-[#0C1014]  flex justify-center w-full ">
        <div className={`py-[10px] px-0 ${isInvolvePassword && "pt-32 "}`}>
          ...
          >
            ...
            <Outlet />
            {pathName === "/accounts/password/reset" && (
              <div className="h-[44px] bg-[#25292E] w-[350px] justify-self-end flex items-center justify-center text-[14px] font-semibold">
                <Link
                  to="/accounts/login"
                  className="text-[white] hover:underline "
                >
                  {forgotPassworText.text9}
                </Link>
              </div>
            )}
          </div>
          {pathName === "/accounts/emailsignup" && (
            <div className="border border-[#363636]  mt-3  text-[#A8A8A8] flex flex-col items-center py-4">
              <p>{signupText.text15}</p>
              <Link
                to="/accounts/login"
                className="text-[#708DF0] font-semibold"
              >
                {signupText.text16}
              </Link>
            </div>
      ...
      <div className="flex flex-col  gap-3 bg-[#0C1014] pt-[44px] ">
        <div className="flex gap-3 justify-center flex-wrap">
          {footerData.map((data) => (
            <Link
              to={data.path}
              className="text-[#A8A8A8] text-[12px] hover:underline"
              key={data.linkName}
            >
              {data.linkName}
            </Link>
        ...
        <div className="flex justify-center gap-3  bg-[#0C1014] ">
          <select
            className="bg-transparent text-[#A8A8A8] text-[12px] border-none"
            value={language}
